  ...
  return (
    <Container className="p-5">
      ...
      { <><Slider
        ...
        sliderText={"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum ut magna nulla. Fusce quis justo diam. Sed eget ante ac velit vestibulum porta. Cras scelerisque enim feugiat lacinia tempor. Sed vitae convallis tortor. "} /><Row fluid="md" className="p-5 ">
